...
public class AddAppointment {
    ...
    public void addAppointmentModal(TableView tableView , FilteredList<Appointment> sortedAppointments, ObservableList<Appointment> appointments , Worker worker) {
        ...
        saveButton.setOnAction(event -> {
            ...
            Appointment appointment = new Appointment(textField1.getText() , worker.getName() , textField3.getText() , genderComboBox.getValue() , Integer.parseInt(String.valueOf(textField2.getText())) , datePicker.getValue().toString() ,timeBox.getValue().toString());
