...
public class AppointmentController {
    ...
    public void validation() {
        ...
        if(doctorName.getText() == null || doctorName.getText().isEmpty()){
            CustomAlert alert = new CustomAlert();
    ...
    public void onChoosing(){
        ...
        if (selectedDoctor != null && datePicker.getValue() != null) {
            ...
            Set<Appointment> allAppointments = appointmentHelper.getAppointmentsByDoctorName(selectedDoctor);
    ...
    public void createAppointment(){
        validation();
        Appointment newAppointment = new Appointment(patientName.getText(), doctorName.getText() , description.getText(), choiceBox.getValue().toString() , 19 , datePicker.getValue().format(formatter).toString(), "12:00");
        try {
